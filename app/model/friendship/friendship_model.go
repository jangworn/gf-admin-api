...
// arModel is a active record design model for table friendship operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of friendship.
	Table = "friendship"
	// Model is the model object of friendship.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table friendship.
	Columns = struct {
		Id          string //           
