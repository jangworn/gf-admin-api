...
// arModel is a active record design model for table chatroom operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of chatroom.
	Table = "chatroom"
	// Model is the model object of chatroom.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table chatroom.
	Columns = struct {
		Id          string // id                     
        Name        string // 群聊名称               
