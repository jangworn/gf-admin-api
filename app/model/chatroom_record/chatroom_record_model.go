...
// arModel is a active record design model for table chatroom_record operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of chatroom_record.
	Table = "chatroom_record"
	// Model is the model object of chatroom_record.
