...
// arModel is a active record design model for table client operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of client.
	Table = "client"
	// Model is the model object of client.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table client.
	Columns = struct {
		Id          string // 自增                                           
        Name        string // 客户名称                                       
        KfId        string // 接到客服id                                     
