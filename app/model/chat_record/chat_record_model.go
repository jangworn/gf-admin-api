...
// arModel is a active record design model for table chat_record operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of chat_record.
	Table = "chat_record"
	// Model is the model object of chat_record.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table chat_record.
	Columns = struct {
		Id        string // id      
        Sender    string // 发送人  
        Receiver  string // 接收人  
