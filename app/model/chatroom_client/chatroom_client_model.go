...
// arModel is a active record design model for table chatroom_client operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of chatroom_client.
	Table = "chatroom_client"
	// Model is the model object of chatroom_client.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table chatroom_client.
	Columns = struct {
		Id       string // id          
